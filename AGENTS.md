...
This project is indexed by GitNexus as **miyabi-cli-standalone** (5123 symbols, 11334 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
